...
type ShareableConceptMapProperty struct {
...
type ShareableConceptMapAdditionalAttribute struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableConceptMapGroupElementTarget struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Property []ShareableConceptMapGroupElementTargetProperty `json:"property,omitempty"`
	// Other properties required for this mapping
	DependsOn []ShareableConceptMapGroupElementTargetDependsOn `json:"dependsOn,omitempty"`
	// Other data elements that this mapping also produces
	Product []interface{} `json:"product,omitempty"`
}

type ShareableConceptMapGroupElementTargetDependsOn struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableConceptMapGroupUnmapped struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableConceptMap struct {
	...
	Property []ShareableConceptMapProperty `json:"property,omitempty"`
	// Definition of an additional attribute to act as a data source or target
	AdditionalAttribute []ShareableConceptMapAdditionalAttribute `json:"additionalAttribute,omitempty"`
	...
	Group []ShareableConceptMapGroup `json:"group,omitempty"`
}

type ShareableConceptMapGroup struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Element []ShareableConceptMapGroupElement `json:"element"`
	// What to do when there is no mapping target for the source concept and ConceptMap.group.element.noMap is not true
	Unmapped *ShareableConceptMapGroupUnmapped `json:"unmapped,omitempty"`
}

type ShareableConceptMapGroupElement struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Target []ShareableConceptMapGroupElementTarget `json:"target,omitempty"`
}

type ShareableConceptMapGroupElementTargetProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type OtherShareableConceptMap ShareableConceptMap

func (s ShareableConceptMap) ResourceType() string {
	return "ShareableConceptMap"
}

func (s ShareableConceptMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherShareableConceptMap
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherShareableConceptMap: OtherShareableConceptMap(s), ResourceType: s.ResourceType()})
}

func UnmarshalShareableConceptMap(b []byte) (res ShareableConceptMap, err error) {
