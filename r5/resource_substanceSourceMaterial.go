...
func (s SubstanceSourceMaterial) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherSubstanceSourceMaterial
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherSubstanceSourceMaterial: OtherSubstanceSourceMaterial(s), ResourceType: s.ResourceType()})
}

func UnmarshalSubstanceSourceMaterial(b []byte) (res SubstanceSourceMaterial, err error) {
