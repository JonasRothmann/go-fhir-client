...
type BatchResponseBundle struct {
	...
	Link []BatchResponseBundleLink `json:"link,omitempty"`
	// Entry in the bundle - will have a resource or information
	Entry []BatchResponseBundleEntry `json:"entry,omitempty"`
	// Digital Signature
...
type BatchResponseBundleLink struct {
...
type BatchResponseBundleEntry struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Search *BatchResponseBundleEntrySearch `json:"search,omitempty"`
	// Additional execution information (transaction/batch/history)
	Request *BatchResponseBundleEntryRequest `json:"request,omitempty"`
	// Results of execution (transaction/batch/history)
	Response *BatchResponseBundleEntryResponse `json:"response,omitempty"`
}

type BatchResponseBundleEntrySearch struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type BatchResponseBundleEntryRequest struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type BatchResponseBundleEntryResponse struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type OtherBatchResponseBundle BatchResponseBundle

func (b BatchResponseBundle) ResourceType() string {
	return "BatchResponseBundle"
}

func (b BatchResponseBundle) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherBatchResponseBundle
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherBatchResponseBundle: OtherBatchResponseBundle(b), ResourceType: b.ResourceType()})
}

func UnmarshalBatchResponseBundle(b []byte) (res BatchResponseBundle, err error) {
