...
type BatchBundle struct {
	...
	Link []BatchBundleLink `json:"link,omitempty"`
	// Entry in the bundle - will have a resource or information
	Entry []BatchBundleEntry `json:"entry,omitempty"`
	// Digital Signature
...
type BatchBundleEntry struct {
	...
	Search *BatchBundleEntrySearch `json:"search,omitempty"`
	// Additional execution information (transaction/batch/history)
	Request *BatchBundleEntryRequest `json:"request,omitempty"`
	// Results of execution (transaction/batch/history)
	Response *BatchBundleEntryResponse `json:"response,omitempty"`
}

type BatchBundleEntrySearch struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type BatchBundleEntryRequest struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type BatchBundleEntryResponse struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type OtherBatchBundle BatchBundle

func (b BatchBundle) ResourceType() string {
	return "BatchBundle"
}

func (b BatchBundle) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherBatchBundle
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherBatchBundle: OtherBatchBundle(b), ResourceType: b.ResourceType()})
}

func UnmarshalBatchBundle(b []byte) (res BatchBundle, err error) {
