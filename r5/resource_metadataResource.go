...
func (m MetadataResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherMetadataResource
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherMetadataResource: OtherMetadataResource(m), ResourceType: m.ResourceType()})
}

func UnmarshalMetadataResource(b []byte) (res MetadataResource, err error) {
