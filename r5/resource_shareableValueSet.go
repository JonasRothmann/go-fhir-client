...
type ShareableValueSetExpansionParameter struct {
...
type ShareableValueSetExpansionContainsProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	SubProperty []ShareableValueSetExpansionContainsPropertySubProperty `json:"subProperty,omitempty"`
}

type ShareableValueSetComposeIncludeConcept struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Designation []ShareableValueSetComposeIncludeConceptDesignation `json:"designation,omitempty"`
}

type ShareableValueSetComposeIncludeFilter struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableValueSetComposeInclude struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Concept []ShareableValueSetComposeIncludeConcept `json:"concept,omitempty"`
	// Select codes/concepts by their properties (including relationships)
	Filter []ShareableValueSetComposeIncludeFilter `json:"filter,omitempty"`
...
type ShareableValueSetComposeIncludeConceptDesignation struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableValueSetExpansion struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Parameter []ShareableValueSetExpansionParameter `json:"parameter,omitempty"`
	// Additional information supplied about each concept
	Property []ShareableValueSetExpansionProperty `json:"property,omitempty"`
	// Codes in the value set
	Contains []ShareableValueSetExpansionContains `json:"contains,omitempty"`
}

type ShareableValueSetExpansionProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableValueSetExpansionContains struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Property []ShareableValueSetExpansionContainsProperty `json:"property,omitempty"`
	// Codes contained under this entry
	Contains []interface{} `json:"contains,omitempty"`
}

type ShareableValueSetExpansionContainsPropertySubProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableValueSet struct {
	...
	Compose *ShareableValueSetCompose `json:"compose,omitempty"`
	// Used when the value set is "expanded"
	Expansion *ShareableValueSetExpansion `json:"expansion,omitempty"`
	...
	Scope *ShareableValueSetScope `json:"scope,omitempty"`
}

type ShareableValueSetCompose struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Include []ShareableValueSetComposeInclude `json:"include"`
...
type ShareableValueSetScope struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type OtherShareableValueSet ShareableValueSet

func (s ShareableValueSet) ResourceType() string {
	return "ShareableValueSet"
}

func (s ShareableValueSet) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherShareableValueSet
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherShareableValueSet: OtherShareableValueSet(s), ResourceType: s.ResourceType()})
}

func UnmarshalShareableValueSet(b []byte) (res ShareableValueSet, err error) {
