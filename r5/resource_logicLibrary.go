...
type LogicLibraryContent struct {
...
type OtherLogicLibrary LogicLibrary

func (l LogicLibrary) ResourceType() string {
	return "LogicLibrary"
}

func (l LogicLibrary) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherLogicLibrary
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherLogicLibrary: OtherLogicLibrary(l), ResourceType: l.ResourceType()})
}

func UnmarshalLogicLibrary(b []byte) (res LogicLibrary, err error) {
