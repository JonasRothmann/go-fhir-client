...
type ShareableMeasureSupplementalData struct {
...
type ShareableMeasure struct {
	...
	Term []ShareableMeasureTerm `json:"term,omitempty"`
	// Additional guidance for implementers (deprecated)
	Guidance *custom.Markdown `json:"guidance,omitempty"`
	// Population criteria group
	Group []ShareableMeasureGroup `json:"group,omitempty"`
	// What other data should be reported with the measure
	SupplementalData []ShareableMeasureSupplementalData `json:"supplementalData,omitempty"`
}

type ShareableMeasureTerm struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableMeasureGroup struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Library []custom.Canonical[Library] `json:"library,omitempty"`
	// Population criteria
	Population []ShareableMeasureGroupPopulation `json:"population,omitempty"`
	// Stratifier criteria for the measure
	Stratifier []ShareableMeasureGroupStratifier `json:"stratifier,omitempty"`
}

type ShareableMeasureGroupPopulation struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableMeasureGroupStratifier struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Component []ShareableMeasureGroupStratifierComponent `json:"component,omitempty"`
}

type ShareableMeasureGroupStratifierComponent struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type OtherShareableMeasure ShareableMeasure

func (s ShareableMeasure) ResourceType() string {
	return "ShareableMeasure"
}

func (s ShareableMeasure) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherShareableMeasure
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherShareableMeasure: OtherShareableMeasure(s), ResourceType: s.ResourceType()})
}

func UnmarshalShareableMeasure(b []byte) (res ShareableMeasure, err error) {
