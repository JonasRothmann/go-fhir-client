...
type ModuleDefinitionLibrary struct {
...
type OtherModuleDefinitionLibrary ModuleDefinitionLibrary

func (m ModuleDefinitionLibrary) ResourceType() string {
	return "ModuleDefinitionLibrary"
}

func (m ModuleDefinitionLibrary) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherModuleDefinitionLibrary
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherModuleDefinitionLibrary: OtherModuleDefinitionLibrary(m), ResourceType: m.ResourceType()})
}

func UnmarshalModuleDefinitionLibrary(b []byte) (res ModuleDefinitionLibrary, err error) {
