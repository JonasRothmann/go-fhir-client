...
type PublishableConceptMap struct {
	...
	Property []PublishableConceptMapProperty `json:"property,omitempty"`
	// Definition of an additional attribute to act as a data source or target
	AdditionalAttribute []PublishableConceptMapAdditionalAttribute `json:"additionalAttribute,omitempty"`
	...
	Group []PublishableConceptMapGroup `json:"group,omitempty"`
}

type PublishableConceptMapProperty struct {
...
type PublishableConceptMapGroupUnmapped struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableConceptMapAdditionalAttribute struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableConceptMapGroup struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Element []PublishableConceptMapGroupElement `json:"element"`
	// What to do when there is no mapping target for the source concept and ConceptMap.group.element.noMap is not true
	Unmapped *PublishableConceptMapGroupUnmapped `json:"unmapped,omitempty"`
}

type PublishableConceptMapGroupElement struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Target []PublishableConceptMapGroupElementTarget `json:"target,omitempty"`
}

type PublishableConceptMapGroupElementTarget struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Property []PublishableConceptMapGroupElementTargetProperty `json:"property,omitempty"`
	// Other properties required for this mapping
	DependsOn []PublishableConceptMapGroupElementTargetDependsOn `json:"dependsOn,omitempty"`
	// Other data elements that this mapping also produces
	Product []interface{} `json:"product,omitempty"`
}

type PublishableConceptMapGroupElementTargetProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableConceptMapGroupElementTargetDependsOn struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type OtherPublishableConceptMap PublishableConceptMap

func (p PublishableConceptMap) ResourceType() string {
	return "PublishableConceptMap"
}

func (p PublishableConceptMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherPublishableConceptMap
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherPublishableConceptMap: OtherPublishableConceptMap(p), ResourceType: p.ResourceType()})
}

func UnmarshalPublishableConceptMap(b []byte) (res PublishableConceptMap, err error) {
