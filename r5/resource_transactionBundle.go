...
type TransactionBundle struct {
	...
	Link []TransactionBundleLink `json:"link,omitempty"`
	// Entry in the bundle - will have a resource or information
	Entry []TransactionBundleEntry `json:"entry,omitempty"`
	// Digital Signature
...
type TransactionBundleLink struct {
...
type TransactionBundleEntry struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Search *TransactionBundleEntrySearch `json:"search,omitempty"`
	// Additional execution information (transaction/batch/history)
	Request *TransactionBundleEntryRequest `json:"request,omitempty"`
	// Results of execution (transaction/batch/history)
	Response *TransactionBundleEntryResponse `json:"response,omitempty"`
}

type TransactionBundleEntrySearch struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type TransactionBundleEntryRequest struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type TransactionBundleEntryResponse struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type OtherTransactionBundle TransactionBundle

func (t TransactionBundle) ResourceType() string {
	return "TransactionBundle"
}

func (t TransactionBundle) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherTransactionBundle
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherTransactionBundle: OtherTransactionBundle(t), ResourceType: t.ResourceType()})
}

func UnmarshalTransactionBundle(b []byte) (res TransactionBundle, err error) {
