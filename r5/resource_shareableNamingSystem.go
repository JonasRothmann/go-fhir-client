...
type ShareableNamingSystemUniqueId struct {
...
type ShareableNamingSystem struct {
	...
	UniqueId []ShareableNamingSystemUniqueId `json:"uniqueId"`
}

type OtherShareableNamingSystem ShareableNamingSystem

func (s ShareableNamingSystem) ResourceType() string {
	return "ShareableNamingSystem"
}

func (s ShareableNamingSystem) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherShareableNamingSystem
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherShareableNamingSystem: OtherShareableNamingSystem(s), ResourceType: s.ResourceType()})
}

func UnmarshalShareableNamingSystem(b []byte) (res ShareableNamingSystem, err error) {
