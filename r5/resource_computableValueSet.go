...
type ComputableValueSetComposeInclude struct {
	...
	Concept []ComputableValueSetComposeIncludeConcept `json:"concept,omitempty"`
	// Select codes/concepts by their properties (including relationships)
	Filter []ComputableValueSetComposeIncludeFilter `json:"filter,omitempty"`
...
type ComputableValueSetComposeIncludeConcept struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Designation []ComputableValueSetComposeIncludeConceptDesignation `json:"designation,omitempty"`
}

type ComputableValueSetComposeIncludeFilter struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ComputableValueSetExpansion struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Parameter []ComputableValueSetExpansionParameter `json:"parameter,omitempty"`
	// Additional information supplied about each concept
	Property []ComputableValueSetExpansionProperty `json:"property,omitempty"`
	// Codes in the value set
	Contains []ComputableValueSetExpansionContains `json:"contains,omitempty"`
}

type ComputableValueSetExpansionParameter struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ComputableValueSetExpansionContains struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Property []ComputableValueSetExpansionContainsProperty `json:"property,omitempty"`
	// Codes contained under this entry
	Contains []interface{} `json:"contains,omitempty"`
}

type ComputableValueSetExpansionContainsProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	SubProperty []ComputableValueSetExpansionContainsPropertySubProperty `json:"subProperty,omitempty"`
}

type ComputableValueSet struct {
	...
	Compose *ComputableValueSetCompose `json:"compose,omitempty"`
	// Used when the value set is "expanded"
	Expansion *ComputableValueSetExpansion `json:"expansion,omitempty"`
	...
	Scope *ComputableValueSetScope `json:"scope,omitempty"`
}

type ComputableValueSetScope struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ComputableValueSetExpansionContainsPropertySubProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ComputableValueSetComposeIncludeConceptDesignation struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ComputableValueSetExpansionProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ComputableValueSetCompose struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Include []ComputableValueSetComposeInclude `json:"include"`
...
type OtherComputableValueSet ComputableValueSet

func (c ComputableValueSet) ResourceType() string {
	return "ComputableValueSet"
}

func (c ComputableValueSet) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherComputableValueSet
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherComputableValueSet: OtherComputableValueSet(c), ResourceType: c.ResourceType()})
}

func UnmarshalComputableValueSet(b []byte) (res ComputableValueSet, err error) {
