...
type PublishableValueSetComposeInclude struct {
	...
	Concept []PublishableValueSetComposeIncludeConcept `json:"concept,omitempty"`
	// Select codes/concepts by their properties (including relationships)
	Filter []PublishableValueSetComposeIncludeFilter `json:"filter,omitempty"`
...
type PublishableValueSetComposeIncludeConcept struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Designation []PublishableValueSetComposeIncludeConceptDesignation `json:"designation,omitempty"`
}

type PublishableValueSetComposeIncludeConceptDesignation struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableValueSetExpansion struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Parameter []PublishableValueSetExpansionParameter `json:"parameter,omitempty"`
	// Additional information supplied about each concept
	Property []PublishableValueSetExpansionProperty `json:"property,omitempty"`
	// Codes in the value set
	Contains []PublishableValueSetExpansionContains `json:"contains,omitempty"`
}

type PublishableValueSetExpansionProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableValueSetExpansionContains struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Property []PublishableValueSetExpansionContainsProperty `json:"property,omitempty"`
	// Codes contained under this entry
	Contains []interface{} `json:"contains,omitempty"`
}

type PublishableValueSetScope struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableValueSetCompose struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Extension
	Extension []Extension `json:"extension,omitempty"`
	...
	Include []PublishableValueSetComposeInclude `json:"include"`
...
type PublishableValueSetComposeIncludeFilter struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableValueSetExpansionParameter struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableValueSetExpansionContainsProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	SubProperty []PublishableValueSetExpansionContainsPropertySubProperty `json:"subProperty,omitempty"`
}

type PublishableValueSetExpansionContainsPropertySubProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type PublishableValueSet struct {
	...
	Compose *PublishableValueSetCompose `json:"compose,omitempty"`
	// Used when the value set is "expanded"
	Expansion *PublishableValueSetExpansion `json:"expansion,omitempty"`
	...
	Scope *PublishableValueSetScope `json:"scope,omitempty"`
}

type OtherPublishableValueSet PublishableValueSet

func (p PublishableValueSet) ResourceType() string {
	return "PublishableValueSet"
}

func (p PublishableValueSet) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherPublishableValueSet
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherPublishableValueSet: OtherPublishableValueSet(p), ResourceType: p.ResourceType()})
}

func UnmarshalPublishableValueSet(b []byte) (res PublishableValueSet, err error) {
