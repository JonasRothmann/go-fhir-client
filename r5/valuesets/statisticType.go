...
const (
	...
	StatisticTypeAbsoluteMedianDifference StatisticType = "absolute-MedianDiff"
	// The number or amount of something.
	StatisticTypeC25463 StatisticType = "C25463"
	...
	StatisticTypeCovariance StatisticType = "0000301"
	// A special use case where the proportion is derived from a formula rather than derived from summary evidence.
	StatisticTypePredictedRisk StatisticType = "predictedRisk"
	// Descriptive measure reported as narrative.
	StatisticTypeDescriptive StatisticType = "descriptive"
	...
	StatisticTypeC93150 StatisticType = "C93150"
	// The relative frequency of occurrence of something.
	StatisticTypeC16726 StatisticType = "C16726"
	// A type of relative effect estimate that compares rates over time (eg events per person-years).
	StatisticTypeIncidenceRateRatio StatisticType = "rate-ratio"
	// The largest possible quantity or degree.
	StatisticTypeC25564 StatisticType = "C25564"
	// The sum of a set of values divided by the number of values in the set.
	StatisticTypeC53319 StatisticType = "C53319"
	...
	StatisticTypeMeanDifference StatisticType = "0000457"
	// The value which has an equal number of values greater and less than it.
	StatisticTypeC28007 StatisticType = "C28007"
	// The smallest possible quantity.
	StatisticTypeC25570 StatisticType = "C25570"
	...
	StatisticTypeC16932 StatisticType = "C16932"
	...
	StatisticTypeC65172 StatisticType = "C65172"
	...
	StatisticTypeC17010 StatisticType = "C17010"
	...
	StatisticTypeC44256 StatisticType = "C44256"
	...
	StatisticTypeRegressionCoefficient StatisticType = "0000565"
	...
	StatisticTypeC93152 StatisticType = "C93152"
	...
	StatisticTypeRiskDifference StatisticType = "0000424"
	...
	StatisticTypeC65171 StatisticType = "C65171"
	...
	StatisticTypeStandardizedMeanDifference StatisticType = "0000100"
)
