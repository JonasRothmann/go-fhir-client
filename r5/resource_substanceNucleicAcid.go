...
func (s SubstanceNucleicAcid) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherSubstanceNucleicAcid
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherSubstanceNucleicAcid: OtherSubstanceNucleicAcid(s), ResourceType: s.ResourceType()})
}

func UnmarshalSubstanceNucleicAcid(b []byte) (res SubstanceNucleicAcid, err error) {
