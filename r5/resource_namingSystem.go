...
func (n NamingSystem) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherNamingSystem
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherNamingSystem: OtherNamingSystem(n), ResourceType: n.ResourceType()})
}

func UnmarshalNamingSystem(b []byte) (res NamingSystem, err error) {
