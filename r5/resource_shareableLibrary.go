...
type OtherShareableLibrary ShareableLibrary

func (s ShareableLibrary) ResourceType() string {
	return "ShareableLibrary"
}

func (s ShareableLibrary) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherShareableLibrary
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherShareableLibrary: OtherShareableLibrary(s), ResourceType: s.ResourceType()})
}

func UnmarshalShareableLibrary(b []byte) (res ShareableLibrary, err error) {
