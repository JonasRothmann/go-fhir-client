...
func (s SubstanceProtein) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherSubstanceProtein
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherSubstanceProtein: OtherSubstanceProtein(s), ResourceType: s.ResourceType()})
}

func UnmarshalSubstanceProtein(b []byte) (res SubstanceProtein, err error) {
