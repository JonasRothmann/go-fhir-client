...
type OtherElmLibrary ElmLibrary

func (e ElmLibrary) ResourceType() string {
	return "ELMLibrary"
}

func (e ElmLibrary) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherElmLibrary
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherElmLibrary: OtherElmLibrary(e), ResourceType: e.ResourceType()})
}

func UnmarshalElmLibrary(b []byte) (res ElmLibrary, err error) {
