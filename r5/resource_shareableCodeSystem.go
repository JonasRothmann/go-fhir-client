...
type ShareableCodeSystemConceptProperty struct {
...
type ShareableCodeSystem struct {
	...
	Filter []ShareableCodeSystemFilter `json:"filter,omitempty"`
	// Additional information supplied about each concept
	Property []ShareableCodeSystemProperty `json:"property,omitempty"`
	// Concepts in the code system
	Concept []ShareableCodeSystemConcept `json:"concept,omitempty"`
}

type ShareableCodeSystemFilter struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableCodeSystemProperty struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type ShareableCodeSystemConcept struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
	...
	Designation []ShareableCodeSystemConceptDesignation `json:"designation,omitempty"`
	// Property value for the concept
	Property []ShareableCodeSystemConceptProperty `json:"property,omitempty"`
	// Child Concepts (is-a/contains/categorizes)
	Concept []interface{} `json:"concept,omitempty"`
}

type ShareableCodeSystemConceptDesignation struct {
	// Unique id for inter-element referencing
	Id *string `json:"id,omitempty"`
	// Additional content defined by implementations
	Extension []Extension `json:"extension,omitempty"`
...
type OtherShareableCodeSystem ShareableCodeSystem

func (s ShareableCodeSystem) ResourceType() string {
	return "ShareableCodeSystem"
}

func (s ShareableCodeSystem) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherShareableCodeSystem
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherShareableCodeSystem: OtherShareableCodeSystem(s), ResourceType: s.ResourceType()})
}

func UnmarshalShareableCodeSystem(b []byte) (res ShareableCodeSystem, err error) {
