...
type OtherCqlLibrary CqlLibrary

func (c CqlLibrary) ResourceType() string {
	return "CQLLibrary"
}

func (c CqlLibrary) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherCqlLibrary
		ResourceType string `json:"resourceType,omitempty"`
	}{OtherCqlLibrary: OtherCqlLibrary(c), ResourceType: c.ResourceType()})
}

func UnmarshalCqlLibrary(b []byte) (res CqlLibrary, err error) {
